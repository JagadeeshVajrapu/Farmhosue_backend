...
const properties = [
  {
    ...
    description:
      'An opulent private villa nestled within 12 acres of manicured gardens. Featuring floor-to-ceiling windows, a private infinity pool, and bespoke interiors crafted by renowned designers. Experience unparalleled luxury in the heart of nature.',
  ...
  },
  {
    ...
    description:
      'A charming boutique cottage offering intimate luxury for couples and small families. Surrounded by ancient trees and flowering gardens, this retreat features a private jacuzzi, fireplace, and panoramic valley views.',
  ...
  },
  {
    ...
    description:
      'The crown jewel of Vidhaan Estate. This expansive farmhouse suite spans two levels with heritage architecture blended with modern luxury. Features a private lake view, spa room, and dedicated concierge.',
  ...
  },
  {
    ...
    description:
      'Elegant suite overlooking our award-winning botanical gardens. Perfect for discerning travelers seeking refined comfort with easy access to estate amenities.',
...
const seed = async () => {
  try {
    ...
    await User.deleteMany({ email: 'admin@vidhaan.com' });
